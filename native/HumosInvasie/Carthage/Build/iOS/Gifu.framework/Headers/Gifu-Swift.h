...
/// A subclass of <code>UIImageView</code> that can be animated using an image name string or raw data.
...
/// The file name should include the <code>.gif</code> extension.
///
...
///
/// \param data GIF image data.
- (void)animateWithImageDataWithData:(NSData * __nonnull)data;

/// Updates the <code>UIImage</code> property of the image view if necessary. This method should not be called manually.
- (void)displayLayer:(CALayer * __null_unspecified)layer;
